<div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
       ...
       @php $Employepermision = App\Models\Permission::where(['user_id'=>auth::user()->id,'module'=>'employes'])->count();@endphp   
                ...
                <li class={{ Request::is('admin/employees')? 'active' : '' }}>
                  ...
                  @endif
                         @php $department = App\Models\Permission::where(['user_id'=>auth::user()->id,'module'=>'department'])->count();@endphp   
                @if($department==1)
                  ...
                  @endif
                         @php $attendance = App\Models\Permission::where(['user_id'=>auth::user()->id,'module'=>'attendance'])->count();@endphp   
                @if($attendance==1)
                  ...
                  @endif
                   @php $payrol = App\Models\Permission::where(['user_id'=>auth::user()->id,'module'=>'payrol'])->count();@endphp   
                @if($payrol==1)
                  ...
                  <li class={{ Request::is('admin/processedPayroll')? 'active' : '' }}>
                    <a href="{{route('processedPayroll')}}">
                        ...
                        <span class="menu-title" data-i18n="services">Process Payroll</span>
                                  ...
                                  @endif
         @php $thresold = App\Models\Permission::where(['user_id'=>auth::user()->id,'module'=>'thresold'])->count();@endphp   
                @if($payrol==1)
...
@endif
         @php $thresold = App\Models\Permission::where(['user_id'=>auth::user()->id,'module'=>'deduction'])->count();@endphp   
@if($thresold==1)
                  ...
                  @endif
                  @php $bounus_add = App\Models\Permission::where(['user_id'=>auth::user()->id,'module'=>'bonus','full_access'=>'1'])->count();@endphp   
@if($bounus_add==1)
                  <li class={{ Request::is('admin/bonus')? 'active' : '' }}>
                    ...
                    @endif
                  @php $bonus = App\Models\Permission::where(['user_id'=>auth::user()->id,'module'=>'bonus'])->count();@endphp   
                 @if($bounus_add==1)
     ...
     <li class=" nav-item"><a href="#"><i class="feather icon-layout"></i><span class="menu-title" data-i18n="Content">Holidays</span></a>
                    <ul class="menu-content">
                        ...
                        <li><a href="content-grid.html"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="Grid">Holiday Pay</span></a>
                        </li>
